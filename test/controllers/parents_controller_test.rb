...
#       post :create, parent: { email: @parent.email, name: @parent.name, password_digest: @parent.password_digest }
#     end
#
...
#     patch :update, id: @parent, parent: { email: @parent.email, name: @parent.name, password_digest: @parent.password_digest }
#     assert_redirected_to parent_path(assigns(:parent))
#   end
#
